...
if($_FILES)
{
    ...
    if( $mimeType == "image/png" )
    {
      if (move_uploaded_file($_FILES["file_to_upload"]["tmp_name"], $target_file)) {
          ...
          $msg = "Erro ao tentar carregar o arquivo!";
      }
...
<ul class="menu">
<li class="menu-text">Curso Segurança PHP</li>
</ul>
</div>
</div>
...
<h3 id="h3Title">Conteúdo</h3>
<form method="post" enctype="multipart/form-data">
  <button class="file-upload button alert" name="bla">            
    <input type="file" class="file-input" name="file_to_upload" />Selecionar arquivo
  </button>
...
<div class="large-12 large-offset-12 columns">
  <div class="row column">
    <div class="">
      <h3 id="h3Title">Lista de arquivo</h3>
    </div>
  </div>
</div>
</div>
